...
tape( 'attached to the returned function is the underlying PRNG', function test( t ) {
	...
	t.strictEqual( arcsine.PRNG, minstd.normalized, 'has property' );
	t.end();
});
...
tape( 'attached to the returned function is the generator seed (integer seed)', function test( t ) {
	...
	t.strictEqual( arcsine.seed[ 0 ], 12345, 'equal to provided seed' );

	arcsine = factory({
		'seed': 12345,
		'prng': minstd.normalized
	});
	t.strictEqual( arcsine.seed, null, 'equal to `null`' );
	t.end();
});
...
tape( 'attached to the returned function is the generator seed length', function test( t ) {
	...
	t.strictEqual( arcsine.seedLength, null, 'equal to `null`' );
	t.end();
});
...
tape( 'attached to the returned function is the generator state', function test( t ) {
	...
	t.strictEqual( arcsine.state, null, 'equal to `null`' );
	t.end();
});
...
tape( 'attached to the returned function is the generator state length', function test( t ) {
	...
	t.strictEqual( arcsine.stateLength, null, 'equal to `null`' );
	t.end();
});
...
tape( 'attached to the returned function is the generator state size', function test( t ) {
	...
	t.strictEqual( arcsine.byteLength, null, 'equal to `null`' );
	t.end();
});
...
tape( 'attached to the returned function is a method to serialize the generator as a JSON object', function test( t ) {
	...
	t.strictEqual( o.name, arcsine.NAME, 'has property' );
	t.deepEqual( o.state, typedarray2json( arcsine.state ), 'has property' );
	t.deepEqual( o.params, [], 'has property' );

	arcsine = factory( 1.0, 2.0 );
	o = arcsine.toJSON();
	...
	t.strictEqual( typeof arcsine.toJSON, 'function', 'has method' );
	t.strictEqual( arcsine.toJSON(), null, 'returns expected value' );
...
tape( 'the function supports specifying the generator state', function test( t ) {
	...
	for ( i = 0; i < 100; i++ ) {
		t.strictEqual( arcsine(), arr[ i ], 'returns expected value. i: '+i+'.' );
	}
	t.end();
});
